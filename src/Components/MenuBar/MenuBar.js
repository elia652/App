...
function MenuBar() {
  ...
  return (
<nav className="navbar navbar-expand-lg navbar-dark bg-dark px-2" style={{background:"#A8C8A7"}}>
    ...
    <div className="collapse navbar-collapse p-2" id="navbarNav">
       ...
       <ul className='navbar-nav ms-auto ms-md-0 me-3 me-lg-4'>
        <li className='nav-item dropdown'>
          <a href="#" className='nav-link drodown-toggle' id="navbarDropdown" role='button' data-bs-toggle="dropdown" aria-expanded="false">
